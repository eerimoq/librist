...
"    param reflector=1|0  enable transparent one-to-many reflector mode (receiver listener only)\n"
"  Advanced Profile\n"
...
"  param cbr-output=1|0  space receiver output at the stream's measured rate\n"
"                        (assumes CBR; applies to the whole context, so every\n"
"                        output url must agree)\n"
